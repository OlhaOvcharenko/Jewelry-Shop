...
function getProducts() {
  return [
    ...
    {
      id: "f79b6c7f-8367-4d2e-ae9b-32a128ab15c3",
      name: "Spring Set",
      size: "S", 
      price: 7000,
      description: "This set consists of pendant, earrings and ring. These jews perfectly suit your any spring outfit.",
      collection: "Spring Collection",
      category: "pendants",
      photo: "spring_collection.jpg", 
      gallery: "earrings_spring_set.jpg,emerald-ring_spring_set.jpg,pendant_spring_collection.jpg", 
      status: "new-added",
      quantity: 1
    },
    {
      id: "8a8d3b13-9312-4d47-9d14-6dd1c35c7f2b",
      name: "Gold Earrings",
      size: "S, M", 
      price: 2000,
      description: "Elevate your style with our exquisite spring collection. Our earrings are designed to accentuate your beauty and add a touch of luxury to any ensemble.",
      collection: "Spring Collection",
      category: "earrings",
